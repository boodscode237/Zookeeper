...
fun main() {
//
    var question = print("Please enter the number of the habitat you would like to view: > ")
    var answer = readln()
    while (answer != "exit") {
            ...
            if (answerToInt == 0) {
                ...
                answer = readln()
            } else if (answerToInt == 1) {
                println(animals[1])
                print("Please enter the number of the habitat you would like to view: > ")
                answer = readln()
            } else if (answerToInt == 2) {
                println(animals[2])
                print("Please enter the number of the habitat you would like to view: > ")
                answer = readln()
            } else if (answerToInt == 3) {
                println(animals[3])
                print("Please enter the number of the habitat you would like to view: > ")
                answer = readln()
            } else if (answerToInt == 4) {
                println(animals[4])
                print("Please enter the number of the habitat you would like to view: > ")
                answer = readln()
            } else if (answerToInt == 5) {
                println(animals[5])
                print("Please enter the number of the habitat you would like to view: > ")
                answer = readln()
          }
